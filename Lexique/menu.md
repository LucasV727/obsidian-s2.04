...
C'est ce qui permet aux gestionnaires de trier, filtrer ou faire des calculs sur un [[Tableau]] très simplement. On peut donc explorer la [[base de données]] sans jamais avoir à taper de [[requêtes (SQL)]].

>[!note]
>[source](https://fr.wikipedia.org/wiki/Menu_(informatique))