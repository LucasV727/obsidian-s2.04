...
C'est ce qui permet aux gestionnaires de trier, filtrer ou faire des calculs sur un [[Tableau]] très simplement. On peut donc explorer la [[base de donnée]] sans jamais avoir à taper de [[requetes (sql)]].
